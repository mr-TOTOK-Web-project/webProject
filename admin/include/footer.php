...
$(function() {
  ...
  if(pageName.includes('roomPayment')|| pageName.includes('eventPayment')){
    ...
    Copyright &copy;2024-<script>document.write(new Date().getFullYear());</script><a href="https://d3ti.polteksi.ac.id" target="_blank"> D3 Teknologi Informasi Politeknik Semen Indonesia</a> All rights reserved.     
    </div>
</html>