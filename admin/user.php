        ...
        <form id="model-addUser" method="POST" action="admin_functions.php" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="phoneNumber" type="tel" name="contactno" pattern="08[0-9]{10}" placeholder="Phone Number" class="form-control bg-white border-md border-left-0 pl-3" required>
                    </div>
        ...
        <form id="model-updateUser" method="POST" action="admin_functions.php" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="updatephoneNumber" type="tel" name="contactno" pattern="08[0-9]{10}" placeholder="Phone Number" class="form-control bg-white border-md border-left-0 pl-3" required>
                    </div>
