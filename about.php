...
<section class="about-section bg-light p-5" >
            <div class="row">
                <div class="col-md-12 col-lg-6 col-sm-12 mt-4">
                    <h1 class="ml-5 mb-3 font-weight-bold text-dark">TENTANG KAMI</h1>
                    <p class="title-para ml-5">Guest House Semen Gresik adalah akomodasi yang nyaman dan terjangkau di pusat kota Gresik, Jawa Timur. Berikut beberapa informasi mengenai Guest House Semen Gresik:</p>
                    <ul>
                      <li class="title-para ml-5">
                          <h6>Lokasi:</h6>
                          <p>Guest House Semen Gresik terletak di Jl. Arif Rahman Hakim Gg. VI No.2, Kramatandap, Gapurosukolilo, Kec. Gresik, Gresik 61111</p>
                      </li>
                      <li class="title-para ml-5">
                          <h6>Fasilitas:</h6>
                          <p>Hotel ini menawarkan WiFi gratis dan layanan kamar. Setiap kamar dilengkapi dengan TV layar datar dan saluran kabel. Kamar mandi bersama dan seprai juga disediakan.</p>
                      </li>
                      <li class="title-para ml-5">
                          <h6>Review:</h6>
                          <p>Guest House Semen Gresik memiliki rating 7.3 dari 145 ulasan</p>
                      </li>
                  </ul>
                  <p class="title-para ml-5">Jika Anda mencari akomodasi yang terjangkau dan nyaman di Gresik, Guest House Semen Gresik bisa menjadi pilihan yang baik!</p>
