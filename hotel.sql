...
(1, 'Guest House Semen Gresik', 'Jl. Ibrahim Zahier, Jegong, Sidorukun, Kec. Gresik ', 'Gresik', 'Jawa Timur', 'Indonesia', 'Indonesia', 61112, 'elite@gmail.com', 89658968555, 123456789, ' Whether you book a hotel online, on the phone, or through a travel agent, it should be a simple process.                  It should be easy to contact a knowledgeable, helpful person');
...
(35, 13, 16, '2024-05-11', '2024-05-11 04:01:11', '2024-05-18', '2024-05-25', '3', 8400, 'tamu@mail.com', 85853728182, 'CheckedOut');
...
(5, 35, 'Net Banking', '2024-05-11', 8400, 'Paid');
...
(16, 'tamu', 'tamu', 'tamu@mail.com', '1234', '085857948283', 'male', 'avatar3.png', 'active');
...
--
ALTER TABLE `room_booking`
  MODIFY `BookingId` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
